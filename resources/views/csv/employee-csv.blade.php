            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        ...
                        <a><?php echo( "<button class = 'btn btn-dark buttondesign' onclick= \"location.href='/employees'\"><i class='fas fa-user-tie'></i> Employee List</button>");?></a> 
                        </div>
                        <div class="card-body">
                        <form method ="POST" enctype="multipart/form-data" action="{{route('employee.import')}}">
                        @csrf
                        <div class="form-group">
                            <label for="file">Upload employee csv</label>
                            <input type="file" name="file" class="form-control"/>
                        </div>
                        <button type="submit" class="btn btn-primary buttondesign">Import</button>
                        </form>
